...
class VariableTypeEx{
	...
	public static void main(String[] args){
		...
		VariableTypeEx obj = new VariableTypeEx();		//creat new object

		System.out.println("local variable : "+a);		// local var direct access
		System.out.println("static variable : "+VariableTypeEx.b); 		//static var class name through access
